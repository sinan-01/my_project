        ...
        <div class="col-12">
            ...
            <div class="modern-page-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="modern-title">📚 Yeni Kitap Ekle</h1>
                        <p class="modern-subtitle">Kitap bilgilerini doldurun ve sisteme ekleyin</p>
                    </div>
                    <a href="{{ route('admin.books.index') }}" class="btn btn-outline-secondary btn-modern">
            ...
            <div class="modern-form-card">
                ...
                <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="modern-form-section">
                                <h4 class="section-title">📖 Kitap Bilgileri</h4>
                                
                                <div class="modern-form-group">
                                    <label for="title" class="modern-label">Kitap Başlığı *</label>
                                ...
                                <div class="modern-form-group">
                                    <label for="author" class="modern-label">Yazar</label>
                                    <input type="text" class="modern-input @error('author') is-invalid @enderror" 
                                ...
                                <div class="modern-form-group">
                                    ...
                                    <textarea class="modern-textarea @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Kitap hakkında kısa bir açıklama yazın">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="modern-error">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="modern-form-actions">
                        ...
                        <button type="submit" class="btn btn-modern btn-primary">
                            <i class="lni lni-checkmark"></i> Kitap Ekle
                        </button>
                    </div>
                </form>
            </div>
