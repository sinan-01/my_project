        ...
        <div class="col-12">
            ...
            <div class="modern-page-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="modern-title">🎭 Yeni Slayd Ekle</h1>
                        <p class="modern-subtitle">Ana sayfa için yeni slayd oluşturun</p>
                    </div>
            ...
            <div class="modern-form-card">
                ...
                <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data" class="modern-form">
                    @csrf
                            ...
                            <div class="modern-form-section">
                                ...
                                <div class="modern-form-group">
                                    ...
                                    <textarea class="modern-textarea @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Slayd açıklamasını yazın">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="modern-error">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="modern-form-group">
                                    ...
                                    <div class="modern-file-upload">
                                        ...
                                        <label for="image" class="modern-file-label">
                                            ...
                                            <span>Slayd görselini seçin</span>
                    ...
                    <div class="modern-form-actions">
                        ...
                        <button type="submit" class="btn btn-modern btn-primary">
                            <i class="lni lni-checkmark"></i> Slayd Ekle
                        </button>
                    </div>
                </form>
            </div>
